  ...
  describe("ekco", () => {
    it("should parse", () => {
      ...
      expect(i.spec.ekco).to.deep.equal({
        ...
        expect(i.flags()).to.equal("ekco-node-unreachable-toleration-duration=10m ekco-min-ready-master-node-count=3 ekco-min-ready-worker-node-count=1 ekco-should-disable-reboot-service=0 ekco-rook-should-use-all-nodes=0 ekco-rook-should-disable-reconcile-mds-placement=0 ekco-should-disable-restart-failed-envoy-pods=0 ekco-envoy-pods-not-ready-duration=5m")
    });
  });
